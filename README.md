...
* Request
  * Method: GET
  * URL: users/:userId?userId=userId.query/songs (ALL songs, INCLUDING this artist) ??????
  * Body: none
...
* Request
  * Method: GET
  * URL: songs/:songId ? songId = id.query
  * Body: none
...
* Request
  * Method: POST
  * URL: users/:userId/playlists   ORRRR.  playLists/:userId/playlists 
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: users/:userId/playlists   ORRRR   playList/:userId/:playlistId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: playLists/:userId/playlists
  * Body: none
...
* Request
  * Method: ?
  * URL: users/:userId?isArtist=true
  * Body: none
